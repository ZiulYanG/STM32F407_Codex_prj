#!/usr/bin/env python3
"""Flash a Bootloader image through a DAPLink CMSIS-DAP probe and reset it."""
...
DEFAULT_IMAGE = REPO_ROOT / "firmware" / "Bootloader" / "build" / "Debug" / "Bootloader.elf"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--adapter-speed", type=int, default=1000, help="SWD frequency in kHz.")
    parser.add_argument("--dap-serial", help="CMSIS-DAP serial number; omit when one probe is connected.")
